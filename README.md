...
[https://subdomain-generator.farelmods-ux.storeid.my.id](https://subdomain-generator.farelmods-ux.storeid.my.id)
...
```bash
git clone https://github.com/Farelmods-ux/Subdomain-Generator.git
